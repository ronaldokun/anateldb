...
# %% auto 0
__all__ = ['TIMEOUT', 'RELATORIO', 'ESTACAO', 'SRD', 'TELECOM', 'RADIODIFUSAO', 'APP_ANALISE', 'ESTADOS', 'SIGLAS', 'BW',
           'BW_MAP', 'COLS_TELECOM', 'COLS_SRD', 'SQL_RADCOM', 'SQL_STEL', 'MONGO_TELECOM', 'MONGO_SRD',
           'SQL_VALIDA_COORD', 'BW_pattern', 'REGEX_ESTADOS']
