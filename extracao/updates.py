...
# %% auto 0
__all__ = ['connect_db', 'clean_mosaico', 'update_radcom', 'update_stel', 'update_mosaico', 'update_telecom', 'update_base']
...
def update_stel(
    ...
    with console.status(
        ...
        try:
            ...
            stel.loc[:, "Validade_RF"] = stel.Validade_RF.astype("string").str.slice(
                0, 10
            )
