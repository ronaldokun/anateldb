# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/icao.ipynb.

# %% auto 0
__all__ = ['PATH_NAV', 'PATH_COM', 'PATH_CHANNELS', 'COLS_NAV', 'COLS_COM', 'convert_latitude', 'convert_longitude',
           'map_channels', 'get_icao']
...
# %% ../nbs/icao.ipynb 10
def get_icao(
    path_nav: str,  # Caminho para o arquivo NAV
