...
# %% auto 0
__all__ = ['row2dict', 'dict2cols', 'parse_plano_basico', 'scrape_dataframe', 'input_coordenates', 'parse_bw', 'optimize_floats',
           'optimize_ints', 'optimize_objects', 'df_optimize', 'format_types']
