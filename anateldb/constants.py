...
__all__ = ['URL', 'URLHM', 'URLHM2', 'ACAO_DESCRIPTION', 'ACAO_TRACKER', 'FIELDS', 'CUSTOM_IDS', 'SITUACAO',
           'DICT_FIELDS', 'CLASSE', 'TIPO', 'STATUS', 'SERVICOS', 'PF', 'ID2FIELD', 'FIELD2ID', 'ESTADOS', 'SIGLAS',
           'REGEX_ESTADOS']
...
PF = ('Utilização integral', 'Utilização parcial', 'Não utilização de PF existente',
      'Não se aplica PF - demanda específica', 'Não se aplica PF - uso apenas de formulários',
      'Não se aplica PF - PF inexistente', 'Não se aplica PF - necessidade de elaborar PF',
