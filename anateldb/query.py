...
__all__ = ['ESTACOES', 'PLANO_BASICO', 'HISTORICO', 'REJECT_ESTACOES', 'COL_ESTACOES', 'NEW_ESTACOES', 'COL_PB',
           'NEW_PB', 'TELECOM', 'RADIODIFUSAO', 'RADCOM', 'STEL', 'connect_db', 'update_radcom', 'update_stel',
           'update_mosaico']
